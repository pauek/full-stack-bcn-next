...
export const attachmentsMenuOptions = async (
    ...
    return {
        doc: {
            name: "Document",
            attachments: await data.getPieceAttachmentList(piece, FileType.doc),
        },
        slds: {
            name: "Slides",
            attachments: await data.getPieceAttachmentList(piece, FileType.slide),
        },
        exc: {
            name: "Exercises",
        ...
        quiz: {
            name: "Quiz",
            attachments: await data.getPieceAttachmentList(piece, FileType.quiz),
        },
    }
}
